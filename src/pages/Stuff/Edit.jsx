      ...
      <div className="block m-auto h-screen bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div className="items-center m-5 pb-10 pt-10">
          ...
          <div className="flex justify-center">
            <h5 className="mb-1 m1-5 text-3x1 font-medium text-gray-900 dark:text-white">
              Stuff
            </h5>
          </div>
          <form onSubmit={handleEditStuff} class="max-w-sm mx-auto">
            <div class="mb-5">
              ...
              <input
                type="text"
                id="name"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600
            ...
            <div class="mb-5">
              ...
              >
                ...
                <option
                  value="HTL"
                  selected={forms.category == "HTL" ? "selected" : ""}
                >
                  Hotel
                </option>
                <option
                  value="KLN"
                  selected={forms.category == "KLN" ? "selected" : ""}
                >
                  Kuliner
                </option>
                <option
                  value="Teknisi/Sarpras"
                  selected={
                    forms.category == "Teknisi/Sarpras" ? "selected" : ""
                  }
                >
                  Sarpras
                </option>
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 
