          ...
          <form onSubmit={handleCreateInbound} class="max-w-sm mx-auto">
            <div class="mb-5">
              ...
              <select
                ...
                onChange={(e) => forms.append("stuff_id", e.target.value)}
              >
            ...
            <div class="mb-5">
              ...
              <input
                ...
                id="total"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-teal-500 dark:focus:border-teal-500"
                placeholder="Ketik Total Barang"
                onChange={(e) => forms.append("total", e.target.value)}
              />
            </div>
            <div class="mb-5">
              <label
              ...
              <input
                ...
                onChange={(e) => forms.append("date", e.target.value)}
              />
            </div>
            <div class="mb-5">
              <label
